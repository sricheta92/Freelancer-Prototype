        ...
        <div class=" news-feed panel panel-primary col-md-8 col-offset-md-4 ">
          ...
          <div class="panel-body ">
            {this.props.projectsWithSkills.map(projectsWithSkill =>
              <ProjectFeedItem key={projectsWithSkill.project.project_id} postedBy = {projectsWithSkill.postedBy} projectskills = {projectsWithSkill.skills} projectfeeditem = {projectsWithSkill.project} /> )}
          </div>
